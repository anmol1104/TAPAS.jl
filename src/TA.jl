"""
    tapas(G::Graph, tol, maxIters, maxRunTime, log)

Traffic Assignment by Paired Alternative Segments (TAPAS) algorithm for static multi-class 
...
"""
function tapas(G::Graph, tol, maxiters, maxruntime, log)
